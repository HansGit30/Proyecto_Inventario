...
public class frmMovimiento extends javax.swing.JFrame {
    ...
    private static final java.util.logging.Logger logger = java.util.logging.Logger.getLogger(frmMovimiento.class.getName());
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Consulta Movimiento");
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "ID", "Tipo", "Fecha", "ID Usuario", "ID Categoria", "ID Cliente", "ID Almacen"
            }
        ) {
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(() -> new frmMovimiento().setVisible(true));
    }
