...
public class frmAlmacen extends javax.swing.JFrame {
    ...
    private static final java.util.logging.Logger logger = java.util.logging.Logger.getLogger(frmAlmacen.class.getName());
    ...
    private void initComponents() {
        ...
        jLabel2.setText("Mantenimiento Almacen");
        ...
        jLabel3.setText("Lista Almacen");

        jLabel4.setFont(new java.awt.Font("Segoe UI", 1, 12)); // NOI18N
        jLabel4.setText("ID Almacen");

        jLabel5.setFont(new java.awt.Font("Segoe UI", 1, 12)); // NOI18N
        jLabel5.setText("Nombre Almacen");
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(() -> new frmAlmacen().setVisible(true));
    }
